...
export default function PurchaseNewEditForm({ currentPurchase }: Props) {
  ...
  const defaultValues = useMemo(
    () => ({
      ...
      transactionDate:  currentPurchase?.transactionDate ?  new Date(currentPurchase.transactionDate ) : new Date(),
      description: currentPurchase?.description ?? '',
      creditDateLimit: currentPurchase?.creditDateLimit ?  new Date(currentPurchase.creditDateLimit ) : new Date(),
    ...
    <FormProvider methods={methods}>
      ...
      <Grid container columnSpacing={2}>
        ...
        <Grid item xs={12} md={8} sm={10}>
          <Stack>
            <RHFTextField name="id-descripcion" label="Descripción" value={values.description} />
          </Stack>
        </Grid>
      </Grid>
      ...
      <Grid container columnSpacing={2}>
        ...
        <Grid item xs={12} sm={5} md={3}>
          <RHFTextField disabled name="daysForCredit" label="Plazo de Crédito" value={values.daysForCredit} />
        </Grid>
      ...
      <AddressListDialog
        ...
        selected={(selectedId: string) => values.documentId?.toString() === selectedId}
        onSelect={() => setValue('description', '')}
        list={_addressBooks}
        action={
          <Button
            size="small"
